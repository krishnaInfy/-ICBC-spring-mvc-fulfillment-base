...
<body>
	<div class="container">
		...
		<div class="span-12 last">
			<p>Enter a 15 or 18 character Invoice Statement ID to create an
				order.</p>
			<form:form modelAttribute="order" action="order" method="post">
				<fieldset>
					<legend>Order Fields</legend>
					<p>
						<form:label id="idLabel" for="id" path="id" cssErrorClass="error">Id</form:label>
						<br />
						<form:input path="id" />
						<form:errors path="id" />
					</p>
		...
		<table>
			...
			<c:forEach items="${orders}" var="order">
				<tr>
					<td><a href="orderui/${order.orderId}"><c:out
								value="${order.id}" /></a></td>
					<td><a href="orderui/${order.orderId}"><c:out
